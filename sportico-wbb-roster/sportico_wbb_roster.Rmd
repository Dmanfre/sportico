...
ncaa_yes23_24_seeds %>% 
  group_by(seed) %>% 
  summarize(int_players = sum(int_players_23_24)) %>% 
  arrange(desc(int_players))
...
total number of international players in 2022-23 vs 2023-24 tournament
...
total_players_22_23 <- non_us_22_23 %>% 
  ...
  summarize(total_players = n())
# total int players is 157

#23-24
total_players_23_24 <-  non_us_23_24 %>% 
  filter(team %in% ncaat23_24) %>% 
  summarize(total_players = n())
#total int players is 149


# percentage of international players in the tournament
...
database of internatinal tourney players
```{r}

int_tourney_players_23_24 <- non_us_23_24 %>% 
  filter(team %in% ncaat23_24)
